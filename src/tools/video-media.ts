  ...
  server.registerTool(
    "ads_get_video_media",
    {
      ...
      inputSchema: {
        ...
        max_inline_bytes: z.number().int().min(1_048_576).max(20_971_520).default(20_971_520).describe("inline mode size cap in bytes (hard cap 20 MB over HTTP, 6 MB over stdio, where MCP SDK clients read through a 10 MB buffer)"),
